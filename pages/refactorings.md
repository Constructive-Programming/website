...
*Refactoring* menu in every IDE. This is the same idea seen through the
functional-programming imagination: each move takes a program from one
...
and a property-based test — [hedgehog](https://hedgehog.qa/) on both
sides — that exercises the *before* and *after* on generated inputs and
demands the same answer. Entries without a link are queued; they will
be filled in the order listed.
